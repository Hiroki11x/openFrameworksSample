...
void OpenCVScene3::setup(){
    ...
    //岩瀬 192.168.145.238
//        cap[1] = cv::VideoCapture("http://192.168.154.133:7890/ipvideo.mjpg");
    //    img[0].allocate(CAM_WIDTH, CROP_HEIGHT, OF_IMAGE_COLOR);

    //長田 192.168.157.5
    cap[1] = cv::VideoCapture("http://192.168.150.181:8080/?action=stream");
...
//--------------------------------------------------------------
void OpenCVScene3::keyPressed(int key){
...
//--------------------------------------------------------------
void OpenCVScene3::keyReleased(int key){

}

//--------------------------------------------------------------
void OpenCVScene3::mouseMoved(int x, int y ){

}

//--------------------------------------------------------------
void OpenCVScene3::mouseDragged(int x, int y, int button){

}

//--------------------------------------------------------------
void OpenCVScene3::mousePressed(int x, int y, int button){

}

//--------------------------------------------------------------
void OpenCVScene3::mouseReleased(int x, int y, int button){

}

//--------------------------------------------------------------
void OpenCVScene3::mouseEntered(int x, int y){

}

//--------------------------------------------------------------
void OpenCVScene3::mouseExited(int x, int y){

}

//--------------------------------------------------------------
void OpenCVScene3::windowResized(int w, int h){
    
}

//--------------------------------------------------------------
void OpenCVScene3::gotMessage(ofMessage msg){
    
}

//--------------------------------------------------------------
void OpenCVScene3::dragEvent(ofDragInfo dragInfo){ 
