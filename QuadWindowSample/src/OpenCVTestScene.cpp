...
//--------------------------------------------------------------
void OpenCVTestScene::keyPressed(int key){
...
//--------------------------------------------------------------
void OpenCVTestScene::keyReleased(int key){

}

//--------------------------------------------------------------
void OpenCVTestScene::mouseMoved(int x, int y ){

}

//--------------------------------------------------------------
void OpenCVTestScene::mouseDragged(int x, int y, int button){

}

//--------------------------------------------------------------
void OpenCVTestScene::mousePressed(int x, int y, int button){

}

//--------------------------------------------------------------
void OpenCVTestScene::mouseReleased(int x, int y, int button){

}

//--------------------------------------------------------------
void OpenCVTestScene::mouseEntered(int x, int y){

}

//--------------------------------------------------------------
void OpenCVTestScene::mouseExited(int x, int y){

}

//--------------------------------------------------------------
void OpenCVTestScene::windowResized(int w, int h){

}

//--------------------------------------------------------------
void OpenCVTestScene::gotMessage(ofMessage msg){
