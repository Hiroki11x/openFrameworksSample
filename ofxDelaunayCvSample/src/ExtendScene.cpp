...
//--------------------------------------------------------------
void ExtendScene::keyPressed(int key){

}

//--------------------------------------------------------------
void ExtendScene::keyReleased(int key){

}

//--------------------------------------------------------------
void ExtendScene::mouseMoved(int x, int y ){

}

//--------------------------------------------------------------
void ExtendScene::mouseDragged(int x, int y, int button){

}

//--------------------------------------------------------------
void ExtendScene::mousePressed(int x, int y, int button){

}

//--------------------------------------------------------------
void ExtendScene::mouseReleased(int x, int y, int button){

}

//--------------------------------------------------------------
void ExtendScene::mouseEntered(int x, int y){

}

//--------------------------------------------------------------
void ExtendScene::mouseExited(int x, int y){

}

//--------------------------------------------------------------
void ExtendScene::windowResized(int w, int h){

}

//--------------------------------------------------------------
void ExtendScene::gotMessage(ofMessage msg){
    
}

//--------------------------------------------------------------
void ExtendScene::dragEvent(ofDragInfo dragInfo){ 
